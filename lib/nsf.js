...
module.exports = {
	process: (data) => {
		...
		let segments = [...array.blank_pages(nes_rom, 0), ...array.blank_pages(nes_rom, 255)];
		console.log('empty page segments:');
		console.log(segments);
		nsf_pages.push(segments);
		console.log(array.common(nsf_pages));
